        ...
        <div className="m-2 p-4 text-sm bg-gray-800 text-white rounded-md md:p-6 lg:p-8">
            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    <li className="p-2">
                        Payment Issue — check payment status — <strong className="text-amber-300 font-semibold"> success </strong> — asked DP to deliver the order.
                    </li>
                </div>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <li className="p-2">Payment Issue — check payment status --
                        <strong className="text-amber-300 font-semibold"> pending </strong> — called cx — <strong className="text-red-400 font-semibold"> cx responsive </strong> — cx refused to pay in cash — order still with rider — order cancelled — shared with DP </li>
                ...
                {/* CDO Issues */}
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    <li className="p-2">CDO — cx wanted to cancel due to <strong className="text-amber-300 font-semibold"> change issue </strong> — asked rider to arrange change and ensure delivery.
                    </li>

                    <li className="p-2">CDO — called cx — <strong className="text-red-400 font-semibold"> cx responsive </strong> — cx wanted cancellation due to <strong className="text-amber-300 font-semibold"> change issue </strong> — asked rider to arrange change — DP adamant — guided to SM.
                    </li>
                </div>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <li className="p-2">Payment Issue --<strong className="text-amber-300 font-semibold"> No inactive i.e. COD order </strong> — called cx --<strong className="text-red-400 font-semibold"> cx responsive </strong> — confirmed cx where he paid (Blinket App) — requested DP to manage.
                    </li>
                </div>
                ...
                <div className="p-3 bg-gray-600 rounded-md shadow">
                    <li className="p-2">Payment Issue — check payment status — <strong className="text-amber-300 font-semibold"> pending/No Inactive </strong> — called cx — <strong className="text-red-400 font-semibold"> cx not responsive </strong> — cx refused to pay in cash — order still with rider — order cancelled — shared with DP </li>

                    <li className="p-2">Payment Issue — check payment status — <strong className="text-amber-300 font-semibold"> pending/No Inactive </strong> — called cx — <strong className="text-red-400 font-semibold"> cx not responsive </strong> — cx refused to pay in cash — order already handed over — asked DP to connect with SM </li>
                </div>
