        ...
        <div className="p-3 bg-gray-700 rounded-md shadow">
          <ul className="list-disc pl-5">
            ...
            <br></br>
             ...
             <li className='p-2'>Non Live order related -- dp said that cx said he/she did come in the next x min but till now not came yet -- ETA+ 15 min not cross -- called cx -- cx responsive -- cx said her agent reached at gate in the next 2 min  - same share to rider  & ask to ensure delivery</li> 
            <li className='p-2'>Non Live order related -- dp said that cx said he/she did come in the next x min but till now not came yet -- ETA+ 15 min not cross -- called cx -- cx not responsive -- ask rider to follow automation till ETA +12 min along with some call attempt </li>
