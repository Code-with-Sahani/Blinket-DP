            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li className="p-2">
                            Address Issue-Pin location/ address mismatch -- <strong className="text-yellow-400 font-semibold">Serviceable</strong> -- 1.7 km from pin location  -- pitch extra payout  -- called cx -- <strong className="text-red-400 font-semibold">cx responsive</strong> -- requested cx to called DP for the better location guidance -- ask DP to delivered on address
                        </li>

                        <li className='p-2'>Address Issue-Pin location/ address mismatch -- <strong className="text-yellow-400 font-semibold">Not Serviceable</strong> -- 350 m from pin location -- pitch extra payout -- DP agree -- ask DP to deliver order
                        </li>
