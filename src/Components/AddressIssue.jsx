            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li className='p-2'>Address Issue :  <strong className="text-red-400 font-semibold">Distance b/w location & address &gt; 400 meters :</strong> <strong className="text-red-400 font-semibold"> but distance b/w Store & address &gt; 4 km :</strong> ask rider to deliver the order : raise the ticket for the extra distance if travelled</li>
