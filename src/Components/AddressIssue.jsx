    ...
    return (
        <div className="m-2 p-4 text-sm  bg-gray-800 text-white rounded-md -p-6 lg--p-8">
            ...
            <div className="text-sm border border-green-400 mb-2 mt-4 p-2">
                ...
                <p className="text-sm mb-2 mt-4 p-2">
                     Address issue// location issue -- but rider is not at geo-fence or at location -- ask rider to reach the geo-fence first or at location then coordinate with cx and then deliver the order --if any issue then reconnect us again
                </p>
