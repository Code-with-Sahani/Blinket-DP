...
*/}
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        <li className="p-2">Address Issue -- Distance between <strong className="text-yellow-400 font-semibold"> location & address -- </strong>  is less than 4 km -- ask rider to deliver the order -- raise the ticket for the extra distance if travelled</li>

                        <li className="p-2">Address Issue -- Distance between <strong className="text-yellow-400 font-semibold"> location & address -- </strong>  is less than 4 km --  ask rider to reach the location then coordinate with cx and then deliver the order -- raise the ticket for the extra distance if travelled</li>

                        <li className="p-2">Address Issue -- Distance between <strong className="text-yellow-400 font-semibold"> location & address -- </strong>  is less than 4 km --  called cx -- ask cx to call rider for the better location guidance -- ask rider to deliver the order -- raise the ticket for the extra distance if travelled</li>


                        <li className="p-2">Address Issue -- Distance between <strong className="text-yellow-400 font-semibold"> location & address -- </strong>  is more than 4 km -- Distance b/w <strong className="text-yellow-400 font-semibold">  store & address -- </strong>  is more than 4 km -- <strong className="text-yellow-400 font-semibold">Serviceable store -- </strong> ask rider to deliver the order -- raise the ticket for the extra distance if travelled</li>
