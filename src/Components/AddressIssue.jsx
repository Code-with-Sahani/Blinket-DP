        ...
        <div className="m-2 p-4 text-sm bg-gray-800 text-white rounded-md md:p-6 lg:p-8">
            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        <li className="p-2">
                            Address Issue-Pin location/ address mismatch -- <strong className="text-yellow-400 font-semibold">Serviceable</strong> -- 1.7 km  -- pitch extra payout -- ask DP to delivered on address
                        </li>

                        <li className='p-2'>Address Issue-Pin location/ address mismatch -- <strong className="text-yellow-400 font-semibold">Not Serviceable</strong> -- 350 m -- pitch extra payout -- DP agree -- ask DP to deliver order & denied cancellation
                        </li>

                        <li className='p-2'>Pin location/ address mismatch/ Location issue -- <strong className="text-yellow-400 font-semibold">Not Serviceable</strong> -- 350 m -- pitch extra payout -- DP agree -- called cx -- <strong className="text-red-400 font-semibold">cx responsive</strong> -- requested cx to called DP for the better location guidance -- ask DP to deliver order
                        </li>

                        <li className='p-2'>Address Issue-Pin location/ address mismatch -- <strong className="text-yellow-400 font-semibold">Not Serviceable</strong> -- 5.1 Km -- pitch extra payout -- DP disagree -- call Cx for cancellation & refund details -- Order cancel by me -- Same inform to the DP</li>
