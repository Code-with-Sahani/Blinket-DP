    ...
    return (
        <div className='m-2 p-4 text-sm bg-gray-800 text-white rounded-md md:p-6 lg:p-8'>
            ...
            <div className='space-y-4'>
                <h3 className="text-lg font-bold">Before ETA + 10 mins</h3>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li className='p-2'>CDO -- ETA+10 mins not cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- Error in OS in call recording -- ask DP to follow automation in CDO if cx wants to cancel else deliver the order</li>
                    </ul>
                </div>

                <h3 className="text-lg font-bold">After ETA + 10 mins</h3>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    <h3 className="text-md font-semibold text-emerald-300 mb-4">Cancel due to Delay Reason:</h3>
                    <ul className="list-disc pl-5">
                        <li className='p-2'>CDO -- ETA+10 mins crossed -- <strong className='text-yellow-300 font-semibold'>due to Delay</strong> -- called cx -- <strong className='text-red-400'>cx responsive</strong> -- tried to convince customer -- cx ready to accept -- ask DP to ensure the delivery</li>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    <h3 className="text-md font-semibold text-emerald-300 mb-4">Customer Not Responsive:</h3>
                    <ul className="list-disc pl-5">
                        <li className='p-2'>CDO -- ETA+10 mins cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- call recording available -- cx wants cancel -- order canceled by me -- same shared to DP</li>
                        <li className='p-2'>CDO -- ETA+10 mins cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- call recording available -- cx does not want to cancel -- ask DP to follow automation in CDO if cx wants to cancel else deliver the order</li>
                        <li className='p-2'>CDO -- ETA+10 mins cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- No call recording available -- ask DP to follow automation in CDO if cx wants to cancel else deliver the order</li>
                    </ul>
                </div>
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li className='p-2'>CDO -- ETA+10 mins cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- No call recording available -- ask DP to follow automation in CDO if cx wants to cancel else deliver the order</li>
                         ...
                         <li className='p-2'>CDO -- ETA+10 mins cross -- called cx -- <strong className='text-red-400'>cx not responsive</strong> -- Error in OS in call recording -- ask DP to follow automation in CDO if cx wants to cancel else deliver the order</li>
                    </ul>
                </div>
            </div>
