            ...
            <div className="space-y-4">
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    <ul className="list-disc pl-5">
                        ...
                        <li className="p-2">
                            UMD -- <strong className="text-yellow-300 font-semibold"> DP not marked Enroute not Geo-fence </strong> -- ask DP to first mark enroute then reach Geo-fence --  then try to mark delivered if any issue then connect us again -- DP agreed
                        </li>
