        ...
        <div className="m-2 p-4 text-sm bg-gray-800 text-white rounded-md md:p-6 lg:p-8">
            ...
            <h2 className='text-center text-2xl font-semibold text-emerald-400 mb-1'>UMD -- Unable to mark Delivered</h2>
              <div className="p-3 bg-gray-700 rounded-md shadow">
                    <ul className="list-disc pl-5">
                        <li className="p-2">
                            UMD -- <strong className="text-yellow-300 font-semibold">COD order</strong> -- Payment conmfirmation done from rider -- mark delivered -- share same to the DP
                        </li>
            ...
            <div className="space-y-4">
                ...
                <div className="p-3 bg-gray-700 rounded-md shadow">
                    ...
                    <ul className="list-disc pl-5">
                        <li className="p-2">Payment issue but payment successful, but UMD -- Geo-fence reached -- call cx for confirmation -- get confirmed -- mark delivered -- share same to the DP</li>
                        <li className="p-2">Payment issue but payment successful, but UMD -- Geo-fence reached -- call cx for confirmation -- cx not confirmed -- denied to mark -- asked rider to mark the order as delivered from their end if he delivered</li>
                        <li className="p-2">UMD -- BR -- share the status with him, i.e. Delivered already marked by the main rider -- ask him to mark delivered itself by reaching location Or Co-ordinate SM for the better help</li>
                    </ul>
                </div>
            </div>
        </div>
